...
static const char rm[8][4] = {
    "rne", "rtz", "rdn", "rup", "rmm", "n/a", "n/a", "dyn",
};
...
const char* rv64_print(uint32_t opcode, uintptr_t addr) {
    ...
    //  Generated by https://github.com/ksco/riscv-opcodes/tree/box64_printer
    // Extensions selected : ['rv_a', 'rv_d', 'rv_f', 'rv_i', 'rv_m', 'rv_v', 'rv_zba', 'rv_zbb', 'rv_zbc', 'rv_zicsr', 'rv_zbs', 'rv64_a', 'rv64_d',
    // 'rv64_f', 'rv64_i', 'rv64_m', 'rv64_zba', 'rv64_zbb', 'rv64_zbs', 'rv_zicond', 'rv_zacas', 'rv64_zacas', 'rv_zvkned', 'rv_zvksed', 'rv_zvksh',
    // 'rv_zvknha', 'rv_zifencei', 'rv_zabha']
    //    rv_i, ADD
    ...
    // rv_zabha, AMOADD.B
    if ((opcode & 0xf800707f) == 0x2f) {
        a.rd = FX(opcode, 11, 7);
        a.rs1 = FX(opcode, 19, 15);
        a.rs2 = FX(opcode, 24, 20);
        a.aq = FX(opcode, 26, 26);
        a.rl = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, %s, %s, %s", "AMOADD.B", gpr[a.rd], gpr[a.rs1], gpr[a.rs2], aq[a.aq], rl[a.rl]);
        return buff;
    }
    ...
    // rv_zabha, AMOADD.H
    if ((opcode & 0xf800707f) == 0x102f) {
        a.rd = FX(opcode, 11, 7);
        a.rs1 = FX(opcode, 19, 15);
        a.rs2 = FX(opcode, 24, 20);
        a.aq = FX(opcode, 26, 26);
        a.rl = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, %s, %s, %s", "AMOADD.H", gpr[a.rd], gpr[a.rs1], gpr[a.rs2], aq[a.aq], rl[a.rl]);
        return buff;
    }
    ...
    // rv_zabha, AMOAND.B
    if ((opcode & 0xf800707f) == 0x6000002f) {
        a.rd = FX(opcode, 11, 7);
        a.rs1 = FX(opcode, 19, 15);
        a.rs2 = FX(opcode, 24, 20);
        a.aq = FX(opcode, 26, 26);
        a.rl = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, %s, %s, %s", "AMOAND.B", gpr[a.rd], gpr[a.rs1], gpr[a.rs2], aq[a.aq], rl[a.rl]);
        return buff;
    }
    ...
    // rv_zabha, AMOAND.H
    if ((opcode & 0xf800707f) == 0x6000102f) {
        a.rd = FX(opcode, 11, 7);
        a.rs1 = FX(opcode, 19, 15);
        a.rs2 = FX(opcode, 24, 20);
        a.aq = FX(opcode, 26, 26);
        a.rl = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, %s, %s, %s", "AMOAND.H", gpr[a.rd], gpr[a.rs1], gpr[a.rs2], aq[a.aq], rl[a.rl]);
        return buff;
    }
    ...
    // rv_zabha, AMOCAS.B
    if ((opcode & 0xf800707f) == 0x2800002f) {
        a.rd = FX(opcode, 11, 7);
        a.rs1 = FX(opcode, 19, 15);
        a.rs2 = FX(opcode, 24, 20);
        a.aq = FX(opcode, 26, 26);
        a.rl = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, %s, %s, %s", "AMOCAS.B", gpr[a.rd], gpr[a.rs1], gpr[a.rs2], aq[a.aq], rl[a.rl]);
        return buff;
    }

    // rv_zacas, AMOCAS.D
    if ((opcode & 0xf800707f) == 0x2800302f) {
        a.rd = FX(opcode, 11, 7);
        a.rs1 = FX(opcode, 19, 15);
        a.rs2 = FX(opcode, 24, 20);
        a.aq = FX(opcode, 26, 26);
        a.rl = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, %s, %s, %s", "AMOCAS.D", gpr[a.rd], gpr[a.rs1], gpr[a.rs2], aq[a.aq], rl[a.rl]);
        return buff;
    }

    // rv_zabha, AMOCAS.H
    if ((opcode & 0xf800707f) == 0x2800102f) {
        a.rd = FX(opcode, 11, 7);
        a.rs1 = FX(opcode, 19, 15);
        a.rs2 = FX(opcode, 24, 20);
        a.aq = FX(opcode, 26, 26);
        a.rl = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, %s, %s, %s", "AMOCAS.H", gpr[a.rd], gpr[a.rs1], gpr[a.rs2], aq[a.aq], rl[a.rl]);
        return buff;
    }

    // rv64_zacas, AMOCAS.Q
    if ((opcode & 0xf800707f) == 0x2800402f) {
        a.rd = FX(opcode, 11, 7);
        a.rs1 = FX(opcode, 19, 15);
        a.rs2 = FX(opcode, 24, 20);
        a.aq = FX(opcode, 26, 26);
        a.rl = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, %s, %s, %s", "AMOCAS.Q", gpr[a.rd], gpr[a.rs1], gpr[a.rs2], aq[a.aq], rl[a.rl]);
        return buff;
    }

    // rv_zacas, AMOCAS.W
    if ((opcode & 0xf800707f) == 0x2800202f) {
        a.rd = FX(opcode, 11, 7);
        a.rs1 = FX(opcode, 19, 15);
        a.rs2 = FX(opcode, 24, 20);
        a.aq = FX(opcode, 26, 26);
        a.rl = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, %s, %s, %s", "AMOCAS.W", gpr[a.rd], gpr[a.rs1], gpr[a.rs2], aq[a.aq], rl[a.rl]);
        return buff;
    }

    // rv_zabha, AMOMAX.B
    if ((opcode & 0xf800707f) == 0xa000002f) {
        a.rd = FX(opcode, 11, 7);
        a.rs1 = FX(opcode, 19, 15);
        a.rs2 = FX(opcode, 24, 20);
        a.aq = FX(opcode, 26, 26);
        a.rl = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, %s, %s, %s", "AMOMAX.B", gpr[a.rd], gpr[a.rs1], gpr[a.rs2], aq[a.aq], rl[a.rl]);
        return buff;
    }
    ...
    // rv_zabha, AMOMAX.H
    if ((opcode & 0xf800707f) == 0xa000102f) {
        a.rd = FX(opcode, 11, 7);
        a.rs1 = FX(opcode, 19, 15);
        a.rs2 = FX(opcode, 24, 20);
        a.aq = FX(opcode, 26, 26);
        a.rl = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, %s, %s, %s", "AMOMAX.H", gpr[a.rd], gpr[a.rs1], gpr[a.rs2], aq[a.aq], rl[a.rl]);
        return buff;
    }
    ...
    // rv_zabha, AMOMAXU.B
    if ((opcode & 0xf800707f) == 0xe000002f) {
        a.rd = FX(opcode, 11, 7);
        a.rs1 = FX(opcode, 19, 15);
        a.rs2 = FX(opcode, 24, 20);
        a.aq = FX(opcode, 26, 26);
        a.rl = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, %s, %s, %s", "AMOMAXU.B", gpr[a.rd], gpr[a.rs1], gpr[a.rs2], aq[a.aq], rl[a.rl]);
        return buff;
    }
    ...
    // rv_zabha, AMOMAXU.H
    if ((opcode & 0xf800707f) == 0xe000102f) {
        a.rd = FX(opcode, 11, 7);
        a.rs1 = FX(opcode, 19, 15);
        a.rs2 = FX(opcode, 24, 20);
        a.aq = FX(opcode, 26, 26);
        a.rl = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, %s, %s, %s", "AMOMAXU.H", gpr[a.rd], gpr[a.rs1], gpr[a.rs2], aq[a.aq], rl[a.rl]);
        return buff;
    }
    ...
    // rv_zabha, AMOMIN.B
    if ((opcode & 0xf800707f) == 0x8000002f) {
        a.rd = FX(opcode, 11, 7);
        a.rs1 = FX(opcode, 19, 15);
        a.rs2 = FX(opcode, 24, 20);
        a.aq = FX(opcode, 26, 26);
        a.rl = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, %s, %s, %s", "AMOMIN.B", gpr[a.rd], gpr[a.rs1], gpr[a.rs2], aq[a.aq], rl[a.rl]);
        return buff;
    }
    ...
    // rv_zabha, AMOMIN.H
    if ((opcode & 0xf800707f) == 0x8000102f) {
        a.rd = FX(opcode, 11, 7);
        a.rs1 = FX(opcode, 19, 15);
        a.rs2 = FX(opcode, 24, 20);
        a.aq = FX(opcode, 26, 26);
        a.rl = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, %s, %s, %s", "AMOMIN.H", gpr[a.rd], gpr[a.rs1], gpr[a.rs2], aq[a.aq], rl[a.rl]);
        return buff;
    }
    ...
    // rv_zabha, AMOMINU.B
    if ((opcode & 0xf800707f) == 0xc000002f) {
        a.rd = FX(opcode, 11, 7);
        a.rs1 = FX(opcode, 19, 15);
        a.rs2 = FX(opcode, 24, 20);
        a.aq = FX(opcode, 26, 26);
        a.rl = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, %s, %s, %s", "AMOMINU.B", gpr[a.rd], gpr[a.rs1], gpr[a.rs2], aq[a.aq], rl[a.rl]);
        return buff;
    }
    ...
    // rv_zabha, AMOMINU.H
    if ((opcode & 0xf800707f) == 0xc000102f) {
        a.rd = FX(opcode, 11, 7);
        a.rs1 = FX(opcode, 19, 15);
        a.rs2 = FX(opcode, 24, 20);
        a.aq = FX(opcode, 26, 26);
        a.rl = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, %s, %s, %s", "AMOMINU.H", gpr[a.rd], gpr[a.rs1], gpr[a.rs2], aq[a.aq], rl[a.rl]);
        return buff;
    }
    ...
    // rv_zabha, AMOOR.B
    if ((opcode & 0xf800707f) == 0x4000002f) {
        a.rd = FX(opcode, 11, 7);
        a.rs1 = FX(opcode, 19, 15);
        a.rs2 = FX(opcode, 24, 20);
        a.aq = FX(opcode, 26, 26);
        a.rl = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, %s, %s, %s", "AMOOR.B", gpr[a.rd], gpr[a.rs1], gpr[a.rs2], aq[a.aq], rl[a.rl]);
        return buff;
    }
    ...
    // rv_zabha, AMOOR.H
    if ((opcode & 0xf800707f) == 0x4000102f) {
        a.rd = FX(opcode, 11, 7);
        a.rs1 = FX(opcode, 19, 15);
        a.rs2 = FX(opcode, 24, 20);
        a.aq = FX(opcode, 26, 26);
        a.rl = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, %s, %s, %s", "AMOOR.H", gpr[a.rd], gpr[a.rs1], gpr[a.rs2], aq[a.aq], rl[a.rl]);
        return buff;
    }
    ...
    // rv_zabha, AMOSWAP.B
    if ((opcode & 0xf800707f) == 0x800002f) {
        a.rd = FX(opcode, 11, 7);
        a.rs1 = FX(opcode, 19, 15);
        a.rs2 = FX(opcode, 24, 20);
        a.aq = FX(opcode, 26, 26);
        a.rl = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, %s, %s, %s", "AMOSWAP.B", gpr[a.rd], gpr[a.rs1], gpr[a.rs2], aq[a.aq], rl[a.rl]);
        return buff;
    }
    ...
    // rv_zabha, AMOSWAP.H
    if ((opcode & 0xf800707f) == 0x800102f) {
        a.rd = FX(opcode, 11, 7);
        a.rs1 = FX(opcode, 19, 15);
        a.rs2 = FX(opcode, 24, 20);
        a.aq = FX(opcode, 26, 26);
        a.rl = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, %s, %s, %s", "AMOSWAP.H", gpr[a.rd], gpr[a.rs1], gpr[a.rs2], aq[a.aq], rl[a.rl]);
        return buff;
    }
    ...
    // rv_zabha, AMOXOR.B
    if ((opcode & 0xf800707f) == 0x2000002f) {
        a.rd = FX(opcode, 11, 7);
        a.rs1 = FX(opcode, 19, 15);
        a.rs2 = FX(opcode, 24, 20);
        a.aq = FX(opcode, 26, 26);
        a.rl = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, %s, %s, %s", "AMOXOR.B", gpr[a.rd], gpr[a.rs1], gpr[a.rs2], aq[a.aq], rl[a.rl]);
        return buff;
    }
    ...
    // rv_zabha, AMOXOR.H
    if ((opcode & 0xf800707f) == 0x2000102f) {
        a.rd = FX(opcode, 11, 7);
        a.rs1 = FX(opcode, 19, 15);
        a.rs2 = FX(opcode, 24, 20);
        a.aq = FX(opcode, 26, 26);
        a.rl = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, %s, %s, %s", "AMOXOR.H", gpr[a.rd], gpr[a.rs1], gpr[a.rs2], aq[a.aq], rl[a.rl]);
        return buff;
    }
    ...
    // rv_zifencei, FENCE.I
    if ((opcode & 0x707f) == 0x100f) {
        a.imm = FX(opcode, 31, 20);
        a.rs1 = FX(opcode, 19, 15);
        a.rd = FX(opcode, 11, 7);
        snprintf(buff, sizeof(buff), "%-15s 0x%x(%d), %s, %s", "FENCE.I", SIGN_EXTEND(a.imm, 12), SIGN_EXTEND(a.imm, 12), gpr[a.rs1], gpr[a.rd]);
        return buff;
    }
    ...
    if ((opcode & 0xfc00707f) == 0x3057) {
        ...
        a.imm = FX(opcode, 19, 15);
        a.vm = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, 0x%x(%d), %s", "VADD.VI", vpr[a.vd], vpr[a.vs2], SIGN_EXTEND(a.imm, 5), SIGN_EXTEND(a.imm, 5),
                 vm[a.vm]);
        return buff;
    }
    ...
    // rv_zvkned, VAESDF.VS
    if ((opcode & 0xfe0ff07f) == 0xa600a077) {
        a.vs2 = FX(opcode, 24, 20);
        a.vd = FX(opcode, 11, 7);
        snprintf(buff, sizeof(buff), "%-15s %s, %s", "VAESDF.VS", vpr[a.vs2], vpr[a.vd]);
        return buff;
    }

    // rv_zvkned, VAESDF.VV
    if ((opcode & 0xfe0ff07f) == 0xa200a077) {
        a.vs2 = FX(opcode, 24, 20);
        a.vd = FX(opcode, 11, 7);
        snprintf(buff, sizeof(buff), "%-15s %s, %s", "VAESDF.VV", vpr[a.vs2], vpr[a.vd]);
        return buff;
    }

    // rv_zvkned, VAESDM.VS
    if ((opcode & 0xfe0ff07f) == 0xa6002077) {
        a.vs2 = FX(opcode, 24, 20);
        a.vd = FX(opcode, 11, 7);
        snprintf(buff, sizeof(buff), "%-15s %s, %s", "VAESDM.VS", vpr[a.vs2], vpr[a.vd]);
        return buff;
    }

    // rv_zvkned, VAESDM.VV
    if ((opcode & 0xfe0ff07f) == 0xa2002077) {
        a.vs2 = FX(opcode, 24, 20);
        a.vd = FX(opcode, 11, 7);
        snprintf(buff, sizeof(buff), "%-15s %s, %s", "VAESDM.VV", vpr[a.vs2], vpr[a.vd]);
        return buff;
    }

    // rv_zvkned, VAESEF.VS
    if ((opcode & 0xfe0ff07f) == 0xa601a077) {
        a.vs2 = FX(opcode, 24, 20);
        a.vd = FX(opcode, 11, 7);
        snprintf(buff, sizeof(buff), "%-15s %s, %s", "VAESEF.VS", vpr[a.vs2], vpr[a.vd]);
        return buff;
    }

    // rv_zvkned, VAESEF.VV
    if ((opcode & 0xfe0ff07f) == 0xa201a077) {
        a.vs2 = FX(opcode, 24, 20);
        a.vd = FX(opcode, 11, 7);
        snprintf(buff, sizeof(buff), "%-15s %s, %s", "VAESEF.VV", vpr[a.vs2], vpr[a.vd]);
        return buff;
    }

    // rv_zvkned, VAESEM.VS
    if ((opcode & 0xfe0ff07f) == 0xa6012077) {
        a.vs2 = FX(opcode, 24, 20);
        a.vd = FX(opcode, 11, 7);
        snprintf(buff, sizeof(buff), "%-15s %s, %s", "VAESEM.VS", vpr[a.vs2], vpr[a.vd]);
        return buff;
    }

    // rv_zvkned, VAESEM.VV
    if ((opcode & 0xfe0ff07f) == 0xa2012077) {
        a.vs2 = FX(opcode, 24, 20);
        a.vd = FX(opcode, 11, 7);
        snprintf(buff, sizeof(buff), "%-15s %s, %s", "VAESEM.VV", vpr[a.vs2], vpr[a.vd]);
        return buff;
    }

    // rv_zvkned, VAESKF1.VI
    if ((opcode & 0xfe00707f) == 0x8a002077) {
        a.vs2 = FX(opcode, 24, 20);
        a.imm = FX(opcode, 19, 15);
        a.vd = FX(opcode, 11, 7);
        snprintf(buff, sizeof(buff), "%-15s %s, 0x%x(%d), %s", "VAESKF1.VI", vpr[a.vs2], a.imm, a.imm, vpr[a.vd]);
        return buff;
    }

    // rv_zvkned, VAESKF2.VI
    if ((opcode & 0xfe00707f) == 0xaa002077) {
        a.vs2 = FX(opcode, 24, 20);
        a.imm = FX(opcode, 19, 15);
        a.vd = FX(opcode, 11, 7);
        snprintf(buff, sizeof(buff), "%-15s %s, 0x%x(%d), %s", "VAESKF2.VI", vpr[a.vs2], a.imm, a.imm, vpr[a.vd]);
        return buff;
    }

    // rv_zvkned, VAESZ.VS
    if ((opcode & 0xfe0ff07f) == 0xa603a077) {
        a.vs2 = FX(opcode, 24, 20);
        a.vd = FX(opcode, 11, 7);
        snprintf(buff, sizeof(buff), "%-15s %s, %s", "VAESZ.VS", vpr[a.vs2], vpr[a.vd]);
        return buff;
    }
    ...
    if ((opcode & 0xfc00707f) == 0x24003057) {
        ...
        a.imm = FX(opcode, 19, 15);
        a.vm = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, 0x%x(%d), %s", "VAND.VI", vpr[a.vd], vpr[a.vs2], SIGN_EXTEND(a.imm, 5), SIGN_EXTEND(a.imm, 5),
                 vm[a.vm]);
        return buff;
    }
    ...
    if ((opcode & 0xfc00707f) == 0x60003057) {
        ...
        a.imm = FX(opcode, 19, 15);
        a.vm = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, 0x%x(%d), %s", "VMSEQ.VI", vpr[a.vd], vpr[a.vs2], SIGN_EXTEND(a.imm, 5), SIGN_EXTEND(a.imm, 5),
                 vm[a.vm]);
        return buff;
    }
    ...
    if ((opcode & 0xfc00707f) == 0x7c003057) {
        ...
        a.imm = FX(opcode, 19, 15);
        a.vm = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, 0x%x(%d), %s", "VMSGT.VI", vpr[a.vd], vpr[a.vs2], SIGN_EXTEND(a.imm, 5), SIGN_EXTEND(a.imm, 5),
                 vm[a.vm]);
        return buff;
    }
    ...
    if ((opcode & 0xfc00707f) == 0x78003057) {
        ...
        a.imm = FX(opcode, 19, 15);
        a.vm = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, 0x%x(%d), %s", "VMSGTU.VI", vpr[a.vd], vpr[a.vs2], SIGN_EXTEND(a.imm, 5), SIGN_EXTEND(a.imm, 5),
                 vm[a.vm]);
        return buff;
    }
    ...
    if ((opcode & 0xfc00707f) == 0x74003057) {
        ...
        a.imm = FX(opcode, 19, 15);
        a.vm = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, 0x%x(%d), %s", "VMSLE.VI", vpr[a.vd], vpr[a.vs2], SIGN_EXTEND(a.imm, 5), SIGN_EXTEND(a.imm, 5),
                 vm[a.vm]);
        return buff;
    }
    ...
    if ((opcode & 0xfc00707f) == 0x70003057) {
        ...
        a.imm = FX(opcode, 19, 15);
        a.vm = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, 0x%x(%d), %s", "VMSLEU.VI", vpr[a.vd], vpr[a.vs2], SIGN_EXTEND(a.imm, 5), SIGN_EXTEND(a.imm, 5),
                 vm[a.vm]);
        return buff;
    }
    ...
    if ((opcode & 0xfc00707f) == 0x64003057) {
        ...
        a.imm = FX(opcode, 19, 15);
        a.vm = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, 0x%x(%d), %s", "VMSNE.VI", vpr[a.vd], vpr[a.vs2], SIGN_EXTEND(a.imm, 5), SIGN_EXTEND(a.imm, 5),
                 vm[a.vm]);
        return buff;
    }
    ...
    if ((opcode & 0xfc00707f) == 0xbc003057) {
        ...
        a.imm = FX(opcode, 19, 15);
        a.vm = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, 0x%x(%d), %s", "VNCLIP.WI", vpr[a.vd], vpr[a.vs2], SIGN_EXTEND(a.imm, 5), SIGN_EXTEND(a.imm, 5),
                 vm[a.vm]);
        return buff;
    }
    ...
    if ((opcode & 0xfc00707f) == 0xb8003057) {
        ...
        a.imm = FX(opcode, 19, 15);
        a.vm = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, 0x%x(%d), %s", "VNCLIPU.WI", vpr[a.vd], vpr[a.vs2], SIGN_EXTEND(a.imm, 5), SIGN_EXTEND(a.imm, 5),
                 vm[a.vm]);
        return buff;
    }
    ...
    if ((opcode & 0xfc00707f) == 0xb4003057) {
        ...
        a.imm = FX(opcode, 19, 15);
        a.vm = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, 0x%x(%d), %s", "VNSRA.WI", vpr[a.vd], vpr[a.vs2], SIGN_EXTEND(a.imm, 5), SIGN_EXTEND(a.imm, 5),
                 vm[a.vm]);
        return buff;
    }
    ...
    if ((opcode & 0xfc00707f) == 0xb0003057) {
        ...
        a.imm = FX(opcode, 19, 15);
        a.vm = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, 0x%x(%d), %s", "VNSRL.WI", vpr[a.vd], vpr[a.vs2], SIGN_EXTEND(a.imm, 5), SIGN_EXTEND(a.imm, 5),
                 vm[a.vm]);
        return buff;
    }
    ...
    if ((opcode & 0xfc00707f) == 0x28003057) {
        ...
        a.imm = FX(opcode, 19, 15);
        a.vm = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, 0x%x(%d), %s", "VOR.VI", vpr[a.vd], vpr[a.vs2], SIGN_EXTEND(a.imm, 5), SIGN_EXTEND(a.imm, 5),
                 vm[a.vm]);
        return buff;
    }
    ...
    if ((opcode & 0xfc00707f) == 0x30003057) {
        ...
        a.imm = FX(opcode, 19, 15);
        a.vm = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, 0x%x(%d), %s", "VRGATHER.VI", vpr[a.vd], vpr[a.vs2], SIGN_EXTEND(a.imm, 5), SIGN_EXTEND(a.imm, 5),
                 vm[a.vm]);
        return buff;
    }
    ...
    if ((opcode & 0xfc00707f) == 0xc003057) {
        ...
        a.imm = FX(opcode, 19, 15);
        a.vm = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, 0x%x(%d), %s", "VRSUB.VI", vpr[a.vd], vpr[a.vs2], SIGN_EXTEND(a.imm, 5), SIGN_EXTEND(a.imm, 5),
                 vm[a.vm]);
        return buff;
    }
    ...
    if ((opcode & 0xfc00707f) == 0x84003057) {
        ...
        a.imm = FX(opcode, 19, 15);
        a.vm = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, 0x%x(%d), %s", "VSADD.VI", vpr[a.vd], vpr[a.vs2], SIGN_EXTEND(a.imm, 5), SIGN_EXTEND(a.imm, 5),
                 vm[a.vm]);
        return buff;
    }
    ...
    if ((opcode & 0xfc00707f) == 0x80003057) {
        ...
        a.imm = FX(opcode, 19, 15);
        a.vm = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, 0x%x(%d), %s", "VSADDU.VI", vpr[a.vd], vpr[a.vs2], SIGN_EXTEND(a.imm, 5), SIGN_EXTEND(a.imm, 5),
                 vm[a.vm]);
        return buff;
    }
    ...
    // rv_zvknha, VSHA2CH.VV
    if ((opcode & 0xfe00707f) == 0xba002077) {
        a.vs2 = FX(opcode, 24, 20);
        a.vs1 = FX(opcode, 19, 15);
        a.vd = FX(opcode, 11, 7);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, %s", "VSHA2CH.VV", vpr[a.vs2], vpr[a.vs1], vpr[a.vd]);
        return buff;
    }

    // rv_zvknha, VSHA2CL.VV
    if ((opcode & 0xfe00707f) == 0xbe002077) {
        a.vs2 = FX(opcode, 24, 20);
        a.vs1 = FX(opcode, 19, 15);
        a.vd = FX(opcode, 11, 7);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, %s", "VSHA2CL.VV", vpr[a.vs2], vpr[a.vs1], vpr[a.vd]);
        return buff;
    }

    // rv_zvknha, VSHA2MS.VV
    if ((opcode & 0xfe00707f) == 0xb6002077) {
        a.vs2 = FX(opcode, 24, 20);
        a.vs1 = FX(opcode, 19, 15);
        a.vd = FX(opcode, 11, 7);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, %s", "VSHA2MS.VV", vpr[a.vs2], vpr[a.vs1], vpr[a.vd]);
        return buff;
    }
    ...
    if ((opcode & 0xfc00707f) == 0x3c003057) {
        ...
        a.imm = FX(opcode, 19, 15);
        a.vm = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, 0x%x(%d), %s", "VSLIDEDOWN.VI", vpr[a.vd], vpr[a.vs2], SIGN_EXTEND(a.imm, 5),
                 SIGN_EXTEND(a.imm, 5), vm[a.vm]);
        return buff;
    }
    ...
    if ((opcode & 0xfc00707f) == 0x38003057) {
        ...
        a.imm = FX(opcode, 19, 15);
        a.vm = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, 0x%x(%d), %s", "VSLIDEUP.VI", vpr[a.vd], vpr[a.vs2], SIGN_EXTEND(a.imm, 5), SIGN_EXTEND(a.imm, 5),
                 vm[a.vm]);
        return buff;
    }
    ...
    if ((opcode & 0xfc00707f) == 0x94003057) {
        ...
        a.imm = FX(opcode, 19, 15);
        a.vm = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, 0x%x(%d), %s", "VSLL.VI", vpr[a.vd], vpr[a.vs2], SIGN_EXTEND(a.imm, 5), SIGN_EXTEND(a.imm, 5),
                 vm[a.vm]);
        return buff;
    }
    ...
    // rv_zvksh, VSM3C.VI
    if ((opcode & 0xfe00707f) == 0xae002077) {
        a.vs2 = FX(opcode, 24, 20);
        a.imm = FX(opcode, 19, 15);
        a.vd = FX(opcode, 11, 7);
        snprintf(buff, sizeof(buff), "%-15s %s, 0x%x(%d), %s", "VSM3C.VI", vpr[a.vs2], a.imm, a.imm, vpr[a.vd]);
        return buff;
    }

    // rv_zvksh, VSM3ME.VV
    if ((opcode & 0xfe00707f) == 0x82002077) {
        a.vs2 = FX(opcode, 24, 20);
        a.vs1 = FX(opcode, 19, 15);
        a.vd = FX(opcode, 11, 7);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, %s", "VSM3ME.VV", vpr[a.vs2], vpr[a.vs1], vpr[a.vd]);
        return buff;
    }

    // rv_zvksed, VSM4K.VI
    if ((opcode & 0xfe00707f) == 0x86002077) {
        a.vs2 = FX(opcode, 24, 20);
        a.imm = FX(opcode, 19, 15);
        a.vd = FX(opcode, 11, 7);
        snprintf(buff, sizeof(buff), "%-15s %s, 0x%x(%d), %s", "VSM4K.VI", vpr[a.vs2], a.imm, a.imm, vpr[a.vd]);
        return buff;
    }

    // rv_zvksed, VSM4R.VS
    if ((opcode & 0xfe0ff07f) == 0xa6082077) {
        a.vs2 = FX(opcode, 24, 20);
        a.vd = FX(opcode, 11, 7);
        snprintf(buff, sizeof(buff), "%-15s %s, %s", "VSM4R.VS", vpr[a.vs2], vpr[a.vd]);
        return buff;
    }

    // rv_zvksed, VSM4R.VV
    if ((opcode & 0xfe0ff07f) == 0xa2082077) {
        a.vs2 = FX(opcode, 24, 20);
        a.vd = FX(opcode, 11, 7);
        snprintf(buff, sizeof(buff), "%-15s %s, %s", "VSM4R.VV", vpr[a.vs2], vpr[a.vd]);
        return buff;
    }
    ...
    if ((opcode & 0xfc00707f) == 0xa4003057) {
        ...
        a.imm = FX(opcode, 19, 15);
        a.vm = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, 0x%x(%d), %s", "VSRA.VI", vpr[a.vd], vpr[a.vs2], SIGN_EXTEND(a.imm, 5), SIGN_EXTEND(a.imm, 5),
                 vm[a.vm]);
        return buff;
    }
    ...
    if ((opcode & 0xfc00707f) == 0xa0003057) {
        ...
        a.imm = FX(opcode, 19, 15);
        a.vm = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, 0x%x(%d), %s", "VSRL.VI", vpr[a.vd], vpr[a.vs2], SIGN_EXTEND(a.imm, 5), SIGN_EXTEND(a.imm, 5),
                 vm[a.vm]);
        return buff;
    }
    ...
    if ((opcode & 0xfc00707f) == 0xac003057) {
        ...
        a.imm = FX(opcode, 19, 15);
        a.vm = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, 0x%x(%d), %s", "VSSRA.VI", vpr[a.vd], vpr[a.vs2], SIGN_EXTEND(a.imm, 5), SIGN_EXTEND(a.imm, 5),
                 vm[a.vm]);
        return buff;
    }
    ...
    if ((opcode & 0xfc00707f) == 0xa8003057) {
        ...
        a.imm = FX(opcode, 19, 15);
        a.vm = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, 0x%x(%d), %s", "VSSRL.VI", vpr[a.vd], vpr[a.vs2], SIGN_EXTEND(a.imm, 5), SIGN_EXTEND(a.imm, 5),
                 vm[a.vm]);
        return buff;
    }
    ...
    if ((opcode & 0xfc00707f) == 0x2c003057) {
        ...
        a.imm = FX(opcode, 19, 15);
        a.vm = FX(opcode, 25, 25);
        snprintf(buff, sizeof(buff), "%-15s %s, %s, 0x%x(%d), %s", "VXOR.VI", vpr[a.vd], vpr[a.vs2], SIGN_EXTEND(a.imm, 5), SIGN_EXTEND(a.imm, 5),
                 vm[a.vm]);
        return buff;
    }
