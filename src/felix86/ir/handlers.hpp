...
typedef void (*ir_handle_fn_t)(IREmitter& ir, x86_instruction_t* inst);

#define X(opcode, name, modrm, immsize) void ir_handle_##name(IREmitter& ir, x86_instruction_t* inst);
