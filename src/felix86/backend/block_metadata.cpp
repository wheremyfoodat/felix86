...
backend_block_metadata_t* backend_block_metadata_create() { return new backend_block_metadata_t(); }

void backend_block_metadata_destroy(backend_block_metadata_t* metadata) { delete metadata; }
