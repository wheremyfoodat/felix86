...
// Bytes equivalent to invlpg[rax]; name; ret; -> see FAST_HANDLE(INVLPG) / generator.cpp for explanation
...
#define INVLPG "\x0F\x01\x38" // invlpg[rax]
#define RET "\x00\xC3"        // null byte for the string, and a ret
